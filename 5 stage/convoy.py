...
def main():
    ...
    for x in range(len(data_df)):
        string += f'\n\t<vehicle>\n\t\t<vehicle_id>{data_df.vehicle_id[x]}</vehicle_id>' \
                  f'\n\t\t<engine_capacity>{data_df.engine_capacity[x]}</engine_capacity>' \
                  f'\n\t\t<fuel_consumption>{data_df.fuel_consumption[x]}</fuel_consumption>' \
                  f'\n\t\t<maximum_load>{data_df.maximum_load[x]}</maximum_load>' \
                  f'\n\t</vehicle>'
    string += '\n</convoy>'
